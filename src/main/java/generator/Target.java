...
public enum Target {
	CONJOINT("conjoint", "son", "sa", "", "e", 1,
			new Charge[]{Charge.MESSIANISME, Charge.DEZIANISTE, Charge.JURIANISTE, Charge.MORT, Charge.SORCELLERIE, Charge.HERESIE, Charge.ESCLAVAGE, Charge.CHARLATANISME, Charge.COMPLOT},
	...
	PHENOMENE("phenoméne", "un", "un", "", "", 1,
			new Charge[]{Charge.MESSIANISME, Charge.DEZIANISTE, Charge.JURIANISTE, Charge.MORT, Charge.SORCELLERIE, Charge.HERESIE},
